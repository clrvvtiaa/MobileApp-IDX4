...
class DashboardTab extends StatelessWidget {
  final List<Map<String, dynamic>> menuItems = [
    {'icon': Icons.school, 'label': 'Jurusan'},
    {'icon': Icons.menu_book, 'label': 'Mata Pelajaran'},
    {'icon': Icons.event, 'label': 'Kalender Sekolah'},
    {'icon': Icons.theater_comedy_outlined, 'label': 'Ekstrakulikuler'},
    {'icon': Icons.assignment, 'label': 'Pengumpulan Tugas'},
    {'icon': Icons.phone_android_rounded, 'label': 'Kontak Sekolah'},
    {'icon': Icons.access_time, 'label': 'Jadwal KBM'},
    {'icon': Icons.map, 'label': 'Denah Kelas'},
...
class DetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, String> descriptions = {
      'Jurusan':
          'Rekayasan Perangkat Lunak (RPL),Teknik Komputer Jaringan(TKJ), Teknik Pengelasan (TP), Teknik Otomotif(TO)',
      'Mata Pelajaran':
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Center(
            child: Text(
              'Email: sulistiamharanis@gmail.com',
          ...
          ListTile(
            ...
            subtitle: Text('Sulistia Maharani Syafitri',
                style: TextStyle(color: Colors.grey[600])),
          ),
          ListTile(
